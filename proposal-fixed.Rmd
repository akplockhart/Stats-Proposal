...
How does the use of AI tools impact students' writing performance in academic settings?
Null Hypothesis: There is no significant relationship between students' AI knowledge and their writing performance.
Alternative Hypothesis:There is a significant relationship between students' AI knowledge and their writing performance.
## Description of data
...
```{r}
studentp$year_of_study<-as.factor(studentp$year_of_study)
```
***
# Preview of data
## Pare down variables
...
```{r}
studentp <- studentp %>%
    select(writing_score, ai_knowledge, year_of_study , gpa)
```
...
studentp<-na.omit(studentp) #removing NAs
colSums(is.na(studentp))
...
studentp %>%
  ...
  summarize(n=n(),
            correlation = cor(writing_score, ai_knowledge),
...
```{r, fig.cap = "Figure 1. Histogram of Student Writing Score and The Number of Students with those scores", fig.align = "center", fig.width=16/2, fig.height=9/2}
...
```{r, fig.cap = "Figure 2. SScatterplot of Student writing Scores and their Knowledge of AI", fig.align = "center", fig.width=16/2, fig.height=9/2}
ggplot(studentp, aes(x = ai_knowledge, y = writing_score ))+
  geom_point() +
...
```{r, fig.cap = "Figure 3. Boxplot of Student Writing Scores and Years of Study", fig.align = "center", fig.width=16/2, fig.height=9/2}
ggplot(studentp, aes(x = year_of_study, y = writing_score, fill = year_of_study)) +
  geom_boxplot() +
...
```{r, fig.cap = "Figure 4. Colored Scatterplot of Student Writiing Scores and Their knowledge of AI using year of study", fig.align = "center", fig.width=16/2, fig.height=9/2}
ggplot(studentp, aes(x = ai_knowledge, y = writing_score, color = year_of_study))+
  geom_point() +
  geom_smooth(method = "lm", se = FALSE ) +
